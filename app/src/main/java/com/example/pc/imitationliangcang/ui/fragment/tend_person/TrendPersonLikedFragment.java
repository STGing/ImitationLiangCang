...
public class TrendPersonLikedFragment extends BaseFragment {

    @BindView(R.id.trend_person_detail_like_rv)
    RecyclerView trendPersonDetailLikeRv;

    private TrendPersonDetailAdapter adapter;

    @Override
    public int getLayoutID() {
        return R.layout.trend_person_like_fragment;
    }
    ...
    public String getUrl() {
        ...
        String url = NetWorkUrl.TRENDPERSONDETAILLIKEURL01 + uid + NetWorkUrl.TRENDPERSONDETAILLIKEURL02;
    ...
    public void processData(String s) {
        ...
        if (!TextUtils.isEmpty(s)) {
            ...
            trendPersonDetailLikeRv.setLayoutManager(manager);

            adapter = new TrendPersonDetailAdapter(getActivity(), items);
            trendPersonDetailLikeRv.setAdapter(adapter);
