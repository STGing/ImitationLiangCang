...
public class MagazineFragmentAdapter extends RecyclerView.Adapter<MagazineFragmentAdapter.MagazineFragmentViewHolder> {
    private final Context mContext;
    private final MagazineListBean.DataBean.ItemsBean items;
    private final LayoutInflater mLayouInflater;


    public MagazineFragmentAdapter(Context mContext, MagazineListBean.DataBean.ItemsBean items) {
    ...
    public MagazineFragmentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        MagazineFragmentViewHolder magazineFragmentViewHolder = new MagazineFragmentViewHolder(mLayouInflater.inflate(R.layout.magazine_fragment_item, null, false));
