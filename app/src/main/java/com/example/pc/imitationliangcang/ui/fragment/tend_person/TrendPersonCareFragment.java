...
public class TrendPersonCareFragment extends BaseFragment {


    @BindView(R.id.trend_person_detail_care_rv)
    RecyclerView trendPersonDetailCareRv;

    private TrendPersonDetailAdapter adapter;

    @Override
    public int getLayoutID() {
        return R.layout.trend_person_care_fragment;
    }
    ...
    public String getUrl() {
        ...
        String url = NetWorkUrl.TRENDPERSONDETAILCAREURL01 + uid + NetWorkUrl.TRENDPERSONDETAILCAREURL02;
    ...
    public void processData(String s) {
        ...
        if (!TextUtils.isEmpty(s)) {
            ...
            trendPersonDetailCareRv.setLayoutManager(manager);

            adapter = new TrendPersonDetailAdapter(getActivity(), items);
            trendPersonDetailCareRv.setAdapter(adapter);
