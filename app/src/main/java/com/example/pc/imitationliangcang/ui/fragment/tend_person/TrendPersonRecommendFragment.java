...
public class TrendPersonRecommendFragment extends BaseFragment {


    @BindView(R.id.trend_person_detail_recommend_rv)
    RecyclerView trendPersonDetailRecommendRv;

    private TrendPersonDetailAdapter adapter;

    @Override
    public int getLayoutID() {
        return R.layout.trend_person_recommend_fragment;
    }
    ...
    public String getUrl() {
        ...
        String url = NetWorkUrl.TRENDPERSONDETAILRECOMMENDURL01 + uid + NetWorkUrl.TRENDPERSONDETAILRECOMMENDURL02;
    ...
    public void processData(String s) {
        ...
        if (!TextUtils.isEmpty(s)) {
            ...
            trendPersonDetailRecommendRv.setLayoutManager(manager);

            adapter = new TrendPersonDetailAdapter(getActivity(),items);
            trendPersonDetailRecommendRv.setAdapter(adapter);
